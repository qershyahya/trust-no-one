...
# every letter the game will ever have, and the colour it is drawn in. Assigned once
...
def draw(scr):
    ...
    for r in range(ROWS):
        ...
        for c in range(COLS):
            ...
            # every kind of brick, including the ones that lie. They all look the same, on
            # purpose
            if ch in "#%~c":
