"""Trust No One -- step 23: The brick that is not there.   Run it:  python3 steps/step23.py"""
...
# every letter that is not what it looks like. One, so far
LIARS = set("%")
...
def solid(ch):   # which letters stop you
    # a hologram is solid only while you still believe in it
