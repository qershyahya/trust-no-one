...
def draw(scr, font, big):   # two fonts now
    ...
    # the level and its clock and the coins. Nothing read the total, and the streaks already say
    # the wind
    ...
    # space, not R: R is gone
    tip = "YOU MADE IT OUT — space to run it again" if won else (
