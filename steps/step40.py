"""Trust No One -- step 40: The rest of the tiles.   Run it:  python3 steps/step40.py"""
...
# the world's clock stops when the world does; this one never does
beat = 0                                              # the pictures' own clock
# the six pictures of a spinning coin, filled in by art()
COIN = []
...
def draw(scr, font, big):   # two fonts now
    # draw() is about to change it
    global beat
    # once per picture, whether or not anything moved
