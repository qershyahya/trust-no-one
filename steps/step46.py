"""Trust No One -- step 46: Two doors.   Run it:  python3 steps/step46.py"""
...
# the way out, eight frames of it
DOOR_OK = []
# the same door as it really is, once a stone has found it out
DOOR_BAD = []
# what stands in the wrong door
DEMON = []
...
def art():   # every picture
    ...
    for i in range(door.get_width() // 128):
        ...
        green = one.copy()
        # multiply every pixel by that colour: the red door becomes a green one
