"""Trust No One -- step 47: A stone, tumbling.   Run it:  python3 steps/step47.py"""
...
# the picture of the stone you throw
SHOT = []
...
def draw(scr, font, big):   # two fonts now
    ...
    for pb in pebbles:
        ...
        # turned by where it is, so it tumbles. Turning it to face its direction would read as
        # an arrow
