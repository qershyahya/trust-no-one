"""Trust No One -- step 56: Sounds from a pack.   Run it:  python3 steps/step56.py"""
...
# six recordings, by the name of the sound each one replaces
...
def make_sounds():   # every sound in the game
    ...
    # loaded last, so each one quietly takes the place of the made-up version
    load_recorded()
...
# six wav files from a free pack, loaded after the made-up sounds so they replace them by name
def load_recorded():
